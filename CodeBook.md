...
Extracts the mean,std into firstDataSet
Saves firstDataSet into result_Data_Set/firstDataSet.csv
Uses plur to calculate mean on activity for each id
appends _mean to all data columns
saves the tidy secondDataSet into result_Data_Set/secondDataSet.csv
